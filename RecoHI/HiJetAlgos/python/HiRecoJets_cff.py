...
voronoiBackgroundCalo = cms.EDProducer('VoronoiBackgroundProducer',
                                       ...
                                       excludeV1 = cms.bool(True),
                                       maxVn = cms.int(2),
                                       sameEvent = cms.bool(False),
                                       sameEventAntiktDistance = cms.double(0.2),
                                       sameEventExclusionPtMin = cms.double(25.0),
                                       sameEventExclusionRadius = cms.double(0.4),
